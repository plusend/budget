...
public class BudgetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBudgetRV = (RecyclerView) view.findViewById(R.id.budget_rv);
        mBudgetRV.setLayoutManager(new LinearLayoutManager(getContext()));
        mBudgetAdapter = new BudgetAdapter(getContext(), BudgetApplication.mBudgetList);
