...
public class DetailListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_detail_list, container, false);
        detailRV = (RecyclerView) view.findViewById(R.id.detail_rv);
        mDetailList = new ArrayList<>();
        detailRV.setLayoutManager(new LinearLayoutManager(getContext()));
        mAdapter = new DetailAdapter(getContext(), mDetailList);
...
//                    + " must implement OnFragmentInteractionListener");
    ...
    private void initDetailList() {
        List<Detail> list = JsonDetailUtil.getInstance(getContext()).listDetail();
