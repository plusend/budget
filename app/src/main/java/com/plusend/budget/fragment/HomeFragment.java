...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expenseTV = (TextView) view.findViewById(R.id.expense_num_tv);
        surplusTV = (TextView) view.findViewById(R.id.surplus_num_tv);
        accountBTN = (Button) view.findViewById(R.id.account_btn);

        int expenseNum = BudgetUtil.getInstance().getAllDetailNum(getContext());
